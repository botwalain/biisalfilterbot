class script(object):
    START_TXT = """<b>Hᴇʟʟᴏ {} {},
I Cᴀɴ Pʀᴏᴠɪᴅᴇ Mᴏᴠɪᴇs & Sᴇʀɪᴇs, Jᴜsᴛ Aᴅᴅ Mᴇ Iɴ Yᴏᴜʀ Gʀᴏᴜᴘ Aɴᴅ Eɴᴊᴏʏ 😍
</b>"""
...
<b>• sᴇɴᴅ /tts ᴛᴏ ᴜsᴇ ᴛʜɪs ғᴇᴀᴛᴜʀᴇ</b>"""
    ...
    ABOUT_TEXT = """<b>Hey {}, 
Hosted On : <a href="https://www.heroku.com/">ʜᴇʀᴏᴋᴜ</a>
Managed By : <a href="https://telegram.me/simpshh">DEMON LORD</a>
</b>"""
...
ᴘʟᴇᴀsᴇ ᴊᴏɪɴ ᴏᴜʀ ʀᴇǫᴜᴇsᴛ ɢʀᴏᴜᴘ ᴛᴏ ɢᴇᴛ ✨</b>'''
    ...
    REF_LINK = '''🔗 <b>Hᴇʀᴇ ɪs ᴏᴜʀ ʀᴇғᴇʀʀᴀʟ ʟɪɴᴋ: <code>https://telegram.me/{}?start=ibm-{}</code>
...
"""
    ...
    FILE_CAPTION = """<a href='https://t.me/IBMBotSupport'><b>ɴᴀᴍᴇ : {file_name}</b></a>"""
...
‼️ ᴄʟɪᴄᴋ ᴏɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ ᴛᴏ ᴄʜᴇᴄᴋ ᴀʟʟ ᴀᴠᴀɪʟᴀʙʟᴇ ᴘʟᴀɴs & ɪᴛ's ᴘʀɪᴄᴇs</b>"""
    ...
    BUY_PLAN = """<b>○ <u>ғɪʀsᴛ sᴛᴇᴘ</u> : DM <code>@simpshh</code> ᴜᴘɪ ɪᴅ. 
