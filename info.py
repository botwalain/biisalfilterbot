...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002093599394'))
QR_CODE = environ.get('QR_CODE', '')
START_IMG = environ.get('START_IMG', 'https://graph.org/file/d48641a6ff9ea38271f60.jpg')
BIN_CHANNEL = int(environ.get('BIN_CHANNEL','-1002177697503'))
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002093599394'))
